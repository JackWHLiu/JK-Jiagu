...
public class Utils {
    ...
    public static final String HOST_APK_NAME = "reinforce.apk";
    public static final String HOST_APK_UNPACK_PATH = "reinforce";
    ...
    public static final String HOST_APK_STRING_RES_PATH = "reinforce/res/values/strings.xml";
    public static final String SHELL_APKTOOL_YML_PATH = "shell/apktool.yml";
    public static final String HOST_APK_ENCRYPT_PATH = "shell/assets/Ldal.bin";
