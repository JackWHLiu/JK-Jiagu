...
void Java_cn_jackwhliu_apploader_App_onAppCreate(JNIEnv *, jobject, jobject, jobject, jstring);
jobject Java_cn_jackwhliu_apploader_App_onAppAttach(JNIEnv *, jobject, jobject, jstring);
